...
<template>
  <div>
    <base-card>
      <div>
        <section class="mx-auto my-6 grid max-w-[185rem] grid-cols-2 place-items-center">
          <div class="w-full px-8 py-4">
            ...
            <textarea
              ...
              v-model="userInput"
              class="custom-scroll h-[40vh] w-[90%] resize-none overflow-auto rounded-lg border-4 border-gray-300 p-2 text-xl shadow-md"
            ></textarea>
          </div>
          <div class="w-full px-8 py-4">
            <label for="result-text" class="mb-2 block text-3xl font-bold">Corrected</label>
            <div id="result-text" class="custom-scroll h-[40vh] w-[90%] resize-none overflow-auto whitespace-pre-line rounded-lg border-4 border-gray-300 p-2 text-left text-xl shadow-md"></div>
          </div>
        </section>
