    ...
    <base-card>
      <div>
        <section class="mx-auto my-6 grid max-w-[185rem] grid-cols-2 place-items-center md:mt-0">
          <div class="w-full px-8 pt-4 md:col-span-2 md:px-2">
            <label for="original-text" class="mb-2 block text-3xl font-bold md:text-xl">Original</label>
            <textarea
              id="original-text"
          ...
          <div class="w-full px-8 pt-4 md:col-span-2 md:px-2">
            <label for="result-text" class="mb-2 block text-3xl font-bold md:text-xl">Corrected</label>
